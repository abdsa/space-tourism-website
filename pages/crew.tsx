...
const Home: NextPage = () => {
  return (
    <>
      ...
      >
        <h1 className="justify-self-center font-barlowC text-navText font-thin uppercase tracking-smHeading tablet:ml-20 tablet:justify-self-start desktop:ml-0 tablet:text-smHeading desktop:text-smHeading">
