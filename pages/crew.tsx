...
const Home: NextPage = () => {
  return (
    <>
      ...
      >
        <h1 className="justify-self-center font-barlowC text-navText font-thin uppercase tracking-smHeading tablet:ml-20 tablet:justify-self-start tablet:text-smHeading desktop:ml-0 desktop:text-smHeading">
            ...
            return (
              ...
              >
                ...
                <Image
                  ...
                  width="580"
                  height="712"
                  className="mt-10 max-h-[222px] max-w-[177px] justify-self-center tablet:max-h-[472px] tablet:max-w-[356px] desktop:ml-20 desktop:mt-0 desktop:max-h-[none] desktop:max-w-none"
                  alt={item.name}
                  quality={100}
                  priority
                />
